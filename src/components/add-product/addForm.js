...
class addForm extends Component {
  ...
  render() {
    ...
    if (!localStorage.getItem('token')) {
      items = <div className='notAuth-container'>
        <h1 className="notAuth">please sign in to be able to add products</h1></div>
    } else {
      items = (
        <div className="addForm-card-container col-lg-4 col-md-6 col-sm-6 col-xs-12">
          <div className="addForm-card">
            <img className="addForm-card-img-top" src={this.state.image} alt="preview yourImage"></img>
